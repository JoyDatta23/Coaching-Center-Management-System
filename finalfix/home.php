...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Bree+Serif&family=Heebo:wght@600&display=swap" rel="stylesheet">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="image/1.jpg" alt="..." style="width: 400px; height: 700px;">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="image/2.jpg" alt="..." style="width: 400px; height: 700px;">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="image/3.png" alt="..." style="width: 400px; height: 700px;">
            </div>
        </div>
